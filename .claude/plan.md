...
|---|---|---|
| WEB-0001-InitializePublicSite | Planned | Create the static public site, docs/pricing/trust/changelog routes, lint/build/link-check gates, Vercel-ready config, and launch placeholders that are visibly unresolved. |
