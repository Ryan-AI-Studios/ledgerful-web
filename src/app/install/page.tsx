...
const platformRows = [
  ...
  },
  {
    ...
    note: "Authenticode signing is not yet implemented; SmartScreen may prompt on first run. Prefer Scoop or winget install Ledgerful.Ledgerful for a prebuilt Windows binary; community index last merged predates Latest (measured on 0.2.10) and version PR #423248 remains OPEN.",
  },
];
