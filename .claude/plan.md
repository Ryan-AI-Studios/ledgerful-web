...
| WEB-0002-TruthGatedMarketingPricing | Completed | Add an evidence-led edition ladder and feature matrix with explicit available/beta/local-only/hosted-planned/enterprise-planned states. |
