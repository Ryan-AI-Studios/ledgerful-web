  ...
  return (
    <PageShell>
      ...
      <section className="page-hero compact">
        ...
        <p>
          Install the <code>ledgerful</code> CLI from a pre-built{" "}
          {release.tag} release binary or build from source using Cargo.
        </p>
      </section>
      ...
      <section className="content-band">
        <SectionHeading title="Prerequisites">
          ...
          binaries ({release.tag}) do not require Rust.
        </SectionHeading>
      ...
      <section className="content-band">
        ...
        <p className="doc-caption">
          ...
          measured on 0.2.13 (winget search 2026-09-18; GitHub v0.2.14 published, index may lag. History: older 0.2.12 was PR #430322 merged 2026-09-06; older leftover 0.2.8
