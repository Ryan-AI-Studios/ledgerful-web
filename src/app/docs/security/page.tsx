  ...
  return (
    ...
    >
      ...
      <text
        ...
        opacity="0.78"
      >
        URL is stripped; Bearer token is never persisted to disk.
      </text>
  ...
  return (
    <PageShell>
      ...
      <section className="page-hero compact">
        <p className="hero-kicker">Security architecture</p>
        <h1>Security architecture</h1>
        <p>
          Deep-dive treatment of the local-first boundary, data flow, signing,
          release verification, and subprocessors. For the concise view, see{" "}
        ...
        <div className="trust-content">
          ...
          >
            ...
            >
              ...
              and continue in {release.tag} — see{" "}
              <a
          ...
          >
            ...
            <div
              ...
              style={{ marginBottom: "24px" }}
            >
              <strong>Shipped since v0.1.8 (current {release.tag}):</strong>{" "}
              {supplyChainAttestation.note} The verification commands below
              are actionable for the {release.tag} release. The{" "}
