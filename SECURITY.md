...
Ledgerful is pre-1.0 software. The latest release is v0.2.7. Security fixes are applied to the main branch and included in the next release. There are no backport branches.
...
## Supply chain attestation (shipped since v0.1.8; current v0.2.7)

Ledgerful's release pipeline is hardened with verifiable supply-chain integrity. The following capabilities shipped with v0.1.8 and continue in the current v0.2.7 release:
