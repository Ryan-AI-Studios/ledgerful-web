...
const platformRows = [
  ...
  },
  {
    ...
    note: "Authenticode signing is not yet implemented; SmartScreen may prompt on first run. Prefer Scoop or winget install Ledgerful.Ledgerful for a prebuilt Windows binary; community index is live at 0.2.11 (#423248 merged 2026-08-26).",
  },
];
