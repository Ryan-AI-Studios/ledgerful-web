...
export const launchTruth = {
  ...
  facts: {
    ...
    mcpPackage: {
      ...
      note: "@ledgerful/mcp-server is published on the public npm registry at version 0.1.21. It downloads the prebuilt binary from the v0.2.12 GitHub release (ledgerfulEngineTag pin). The GitHub release MCP tarball (ledgerful-mcp-server-0.1.21.tgz) matches the npm package version. npx and npm install instructions are actionable.",
    ...
    release: {
      ...
      status: "resolved",
      value: "v0.2.12 with SHA-256 checksums, SBOM, and cosign signing",
